...
> python -m torch.distributed.launch --nproc_per_node=4 --use_env main.py --batch-size 64 --epochs 801 --min-lr 5e-6 --data-set 'ImageNet' --output 'checkpoints/SSL/ImageNet'
